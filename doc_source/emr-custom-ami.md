...
+ Amazon EMR 5\.30\.0 and the Amazon EMR 6\.x series are based on Amazon Linux 2\. For these EMR versions, you need to use images based on Amazon Linux 2 for custom AMIs\. To find a base custom AMI, see [Finding a Linux AMI](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/finding-an-ami.html)\.
