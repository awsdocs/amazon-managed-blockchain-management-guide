...
The default managed security group for the master instance in public subnets has the **Group Name** of **ElasticMapReduce\-master**\. It has the following rules\. If you specify a custom managed security group, Amazon EMR will add all the same rules except for the SSH rule\.
